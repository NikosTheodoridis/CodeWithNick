...
#Register the images (Type of images : ICO , PNG)
...
#Buttons 
but1 = Button(wn,padx=14,pady=14,bg="white",fg="grey28",text="1",font=("Courier New",16,"bold"),border = 0)
but2 = Button(wn,padx=14,pady=14,bg="white",fg="grey28",text="2",font=("Courier New",16,"bold"),border = 0)
but3 = Button(wn,padx=14,pady=14,bg="white",fg="grey28",text="3",font=("Courier New",16,"bold"),border = 0)
but4 = Button(wn,padx=14,pady=14,bg="white",fg="grey28",text="4",font=("Courier New",16,"bold"),border = 0)
but5 = Button(wn,padx=14,pady=14,bg="white",fg="grey28",text="5",font=("Courier New",16,"bold"),border = 0)
but6 = Button(wn,padx=14,pady=14,bg="white",fg="grey28",text="6",font=("Courier New",16,"bold"),border = 0)
but7 = Button(wn,padx=14,pady=14,bg="white",fg="grey28",text="7",font=("Courier New",16,"bold"),border = 0)
but8 = Button(wn,padx=14,pady=14,bg="white",fg="grey28",text="8",font=("Courier New",16,"bold"),border = 0)
but9 = Button(wn,padx=14,pady=14,bg="white",fg="grey28",text="9",font=("Courier New",16,"bold"),border = 0)
but0 = Button(wn,padx=79,pady=14,bg="white",fg="grey28",text="0",font=("Courier New",16,"bold"),border = 0)
